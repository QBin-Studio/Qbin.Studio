<section id="process" class="relative overflow-hidden py-24">
	<div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		...
		<p class="text-brand-secondary mt-12 text-center">
			Followed by ongoing
			<strong class="text-brand-primary/80 font-medium">Support & Iteration</strong>
