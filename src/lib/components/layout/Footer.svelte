<footer class="bg-bg-primary border-border/50 border-t">
	<div class="mx-auto max-w-7xl overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
		...
		<div class="mt-8 flex justify-center space-x-6">
			...
			<a
				href="#"
				class="text-brand-secondary hover:text-brand-primary transition-colors duration-150"
			>
		...
		<p class="text-brand-secondary mt-8 text-center text-sm">
			©
